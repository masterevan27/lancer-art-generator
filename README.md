...
style, and three more take those renders further: `generate-3d.py` into a
printable figure, `animate-portrait.py` into a looping animation, and
`generate-expressions.py` into SillyTavern expression sprites.
